...
- **If using the `tala` layout engine and exporting SVG, do not delete the mask or any SVG elements; only replace `UNLICENSED COPY` with an empty string in the generated SVG**
